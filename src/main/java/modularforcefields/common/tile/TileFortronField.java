...
public class TileFortronField extends GenericTile {
    ...
    private final SingleProperty<BlockPos> projectorPos = property(
	    new SingleProperty<>(PropertyTypes.BLOCK_POS, "projectorPos", BlockEntityUtils.OUT_OF_REACH)
		    .onChange(this::onPropertyChange).onTileLoaded(prop -> onPropertyChange(prop, prop.getValue())));
