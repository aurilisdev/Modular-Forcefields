	...
	addComponent(new ScreenComponentMultiLabel(0, 0, matrixStack -> {
	    ...
	    matrixStack.drawString(font,
		    MFFSTextUtils.gui("fortrondevice.transfer", ChatFormatter
			    ...
			    .append(" / s")),
		    25, 45, 4210752, false);
	    matrixStack.drawString(font, MFFSTextUtils.gui("fortrondevice.linked", capacitor.getConnections()), 25, 55,
		    4210752, false);
	    matrixStack.drawString(font, MFFSTextUtils.gui("fortrondevice.frequency", capacitor.getFrequency()), 25, 35,
		    4210752, false);
	}));
	imageHeight += 40;
	inventoryLabelY += 40;
