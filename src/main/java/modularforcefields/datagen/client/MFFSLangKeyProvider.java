...
public class MFFSLangKeyProvider extends BaseLangKeyProvider {
	...
	default:
	    ...
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.manipulationtranslate),
		    "Translation Module");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.shapecube), "Cube Shape Module");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.shapehemisphere),
		    "Hemisphare Shape Module");
	    ...
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantifriendly),
		    "Anti-Friendly Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantihostile),
		    "Anti-Hostile Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantipersonnel),
		    "Anti-Personell Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantispawn),
		    "Anti-Spawn Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeblockaccess),
		    "Block-Access Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeblockalter),
		    "Block-Alter Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradecapacity), "Capacity Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradecollection),
		    "Collection Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradecolorchange),
		    "Color Change Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeconfiscate),
		    "Confiscation Upgrade");
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradedisintegration),
		    "Disintegration Upgrade");
	    ...
	    addItem(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradestabilize),
	    ...
	    addBlock(ModularForcefieldsBlocks.BLOCKS_MFFSMACHINE.getValue(SubtypeMFFSMachine.biometricidentifier),
		    "Biometric Identifier");
	    addBlock(ModularForcefieldsBlocks.BLOCKS_MFFSMACHINE.getValue(SubtypeMFFSMachine.coercionderiver),
		    "Coercion Deriver");
	    addBlock(ModularForcefieldsBlocks.BLOCKS_MFFSMACHINE.getValue(SubtypeMFFSMachine.fortroncapacitor),
		    "Fortron Capacitor");
	    addBlock(ModularForcefieldsBlocks.BLOCKS_MFFSMACHINE.getValue(SubtypeMFFSMachine.fortronfieldprojector),
		    "Fortron Field Projector");
	    addBlock(ModularForcefieldsBlocks.BLOCKS_MFFSMACHINE.getValue(SubtypeMFFSMachine.interdictionmatrix),
		    "Interdiction Matrix");
