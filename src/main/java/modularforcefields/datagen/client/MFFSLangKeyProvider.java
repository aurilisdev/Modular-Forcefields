...
public class MFFSLangKeyProvider extends BaseLangKeyProvider {
	...
	public MFFSLangKeyProvider(DataGenerator gen, Locale locale) {
		super(gen, locale, ModularForcefields.ID);
	}
	...
	protected void addTranslations() {
		...
		default:
			...
			add("itemGroup.itemgroup" + ModularForcefields.ID + "main", "Modular Forcefields");
