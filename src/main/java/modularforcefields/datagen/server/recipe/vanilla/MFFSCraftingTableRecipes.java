...
public class MFFSCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	public void addRecipes(Consumer<FinishedRecipe> output) {
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEM_FOCUSMATRIX.get(), 8)
				//
				.addPattern("R#R")
				//
				.addPattern("#D#")
		...
		CustomShapelessCraftingRecipe.start(ModularForcefieldsItems.ITEM_FREQUENCYCARD.get(), 1)
				//
		...
		CustomShapelessCraftingRecipe.start(ModularForcefieldsItems.ITEM_IDENTIFICATIONCARD.get(), 1)
				//
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.manipulationscale), 2)
				//
				.addPattern("F F")
				//
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.manipulationtranslate), 2)
				//
				.addPattern("FSF")
				//
				.addKey('F', ModularForcefieldsItems.ITEM_FOCUSMATRIX.get())
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.shapecube), 1)
				//
				.addPattern("FFF")
				//
				.addPattern("FFF")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.shapehemisphere), 1)
				//
				.addPattern("FFF")
				//
				.addPattern("F F")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.shapepyramid), 1)
				//
				.addPattern("F  ")
				//
				.addPattern("FF ")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.shapesphere), 1)
				//
				.addPattern(" F ")
				//
				.addPattern("FFF")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantifriendly), 1)
				//
				.addPattern(" W ")
				//
				.addPattern("PFL")
				...
				//
				.addKey('S', Tags.Items.SLIMEBALLS)
				//
				.complete(ModularForcefields.ID, "module_upgrade_antifriendly", output);

		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantihostile), 1)
				//
				.addPattern(" R ")
				//
				.addPattern("PFB")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantipersonnel), 1)
				//
				.addPattern("HFA")
				//
				.addKey('F', ModularForcefieldsItems.ITEM_FOCUSMATRIX.get())
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeantispawn), 1)
				//
				.addPattern(" H ")
				//
				.addPattern("H A")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeblockaccess), 1)
				//
				.addPattern(" C ")
				//
				.addPattern("BFB")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeblockalter), 1)
				//
				.addPattern(" B ")
				//
				.addPattern("BFB")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradecapacity), 1)
				//
				.addPattern("RFR")
				//
				.addKey('F', ModularForcefieldsItems.ITEM_FOCUSMATRIX.get())
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradecollection), 1)
				//
				.addPattern("H H")
				//
				.addPattern(" F ")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradecolorchange), 1)
				//
				.addPattern("DDD")
				//
				.addPattern("DFD")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeconfiscate), 1)
				//
				.addPattern("EYE")
				//
				.addPattern("YFY")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradedisintegration), 1)
				//
				.addPattern(" D ")
				//
				.addPattern("RFR")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeinterior), 1)
				//
				.addPattern("B")
				//
				.addPattern("F")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradeshock), 1)
				//
				.addPattern("DFD")
				//
				.addKey('F', ModularForcefieldsItems.ITEM_FOCUSMATRIX.get())
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradespeed), 1)
				//
				.addPattern("DDD")
				//
				.addPattern("DFD")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradesponge), 1)
				//
				.addPattern("BBB")
				//
				.addPattern("BFB")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradestabilize), 1)
				//
				.addPattern("FGF")
				//
				.addPattern("PSA")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MODULE.getValue(SubtypeModule.upgradestrength), 1)
				//
				.addPattern("SFS")
				//
				.addKey('F', ModularForcefieldsItems.ITEM_FOCUSMATRIX.get())
	...
	public void addMachines(Consumer<FinishedRecipe> output) {
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MFFSMACHINE.getValue(SubtypeMFFSMachine.biometricidentifier), 1)
				//
				.addPattern("FPF")
				//
				.addPattern("P#P")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MFFSMACHINE.getValue(SubtypeMFFSMachine.coercionderiver), 1)
				//
				.addPattern("FPF")
				//
				.addPattern("FRF")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MFFSMACHINE.getValue(SubtypeMFFSMachine.fortroncapacitor), 1)
				//
				.addPattern("PFP")
				//
				.addPattern("PRP")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MFFSMACHINE.getValue(SubtypeMFFSMachine.fortronfieldprojector), 1)
				//
				.addPattern(" D ")
				//
				.addPattern("FFF")
		...
		CustomShapedCraftingRecipe.start(ModularForcefieldsItems.ITEMS_MFFSMACHINE.getValue(SubtypeMFFSMachine.interdictionmatrix), 1)
				//
				.addPattern("###")
				//
				.addPattern("FFF")
