...
public class ModularForcefieldsBlocks {
    ...
    public static final BulkRegistryObject<BlockMachine, SubtypeMFFSMachine> BLOCKS_MFFSMACHINE = new BulkRegistryObject<>(SubtypeMFFSMachine.values(), subtype -> BLOCKS.register(subtype.tag(), () -> new BlockMachine(subtype) {
        @Override
    ...
    public static final RegistryObject<BlockFortronField> BLOCK_FORTRONFIELD = BLOCKS.register("fortronfield", BlockFortronField::new);
