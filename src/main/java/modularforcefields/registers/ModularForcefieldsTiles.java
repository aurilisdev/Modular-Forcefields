...
public class ModularForcefieldsTiles {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES = DeferredRegister
	    .create(Registries.BLOCK_ENTITY_TYPE, ModularForcefields.ID);

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileBiometricIdentifier>> TILE_BIOMETRICIDENTIFIER = BLOCK_ENTITY_TYPES
	    .register("biometricidentifier", () -> new BlockEntityType<>(TileBiometricIdentifier::new, Sets.newHashSet(
		    ...
		    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileCoercionDeriver>> TILE_COERCIONDERIVER = BLOCK_ENTITY_TYPES
	    .register("coercionderiver",
		    () -> new BlockEntityType<>(TileCoercionDeriver::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFortronCapacitor>> TILE_FORTRONCAPACITOR = BLOCK_ENTITY_TYPES
	    .register("fortroncapacitor",
		    () -> new BlockEntityType<>(TileFortronCapacitor::new, Sets.newHashSet(
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileFortronFieldProjector>> TILE_FORTRONFIELDPROJECTOR = BLOCK_ENTITY_TYPES
	    .register("fortronfieldprojector",
		    () -> new BlockEntityType<>(TileFortronFieldProjector::new,
			    ...
			    null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TileInterdictionMatrix>> TILE_INTERDICTIONMATRIX = BLOCK_ENTITY_TYPES
