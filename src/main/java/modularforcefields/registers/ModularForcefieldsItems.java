...
public class ModularForcefieldsItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, ModularForcefields.ID);

    public static final BulkRegistryObject<BlockItemDescriptable, SubtypeMFFSMachine> ITEMS_MFFSMACHINE = new BulkRegistryObject<>(SubtypeMFFSMachine.values(), subtype -> ITEMS.register(subtype.tag(), () -> new BlockItemDescriptable(ModularForcefieldsBlocks.BLOCKS_MFFSMACHINE.getValue(subtype), new Item.Properties(), () -> ModularForcefieldsCreativeTabs.MAIN)));
    public static final BulkRegistryObject<ItemModule, SubtypeModule> ITEMS_MODULE = new BulkRegistryObject<>(SubtypeModule.values(), subtype -> ITEMS.register(subtype.tag(), () -> new ItemModule(subtype, new Item.Properties(), () -> ModularForcefieldsCreativeTabs.MAIN)));
    public static final RegistryObject<Item> ITEM_FOCUSMATRIX = ITEMS.register("focusmatrix", () -> new ItemVoltaic(new Item.Properties(), () -> ModularForcefieldsCreativeTabs.MAIN));
